...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24">
      <div ref={ref} className={`reveal ${visible ? 'revealed' : ''} section-container`}>
        ...
        <div className="max-w-xl mx-auto glass rounded-2xl p-8 text-center">
          <div className="w-16 h-16 rounded-full bg-blue-100 dark:bg-blue-900/40 flex items-center justify-center mx-auto mb-5">
            <svg className="w-8 h-8 text-blue-600 dark:text-blue-400" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.446 1.394c-.14.14-.26.26-.54.26l.19-2.69 4.91-4.44c.22-.197-.047-.307-.34-.11l-6.07 3.82-2.61-.81c-.566-.18-.58-.57.12-.84l10.2-3.93c.47-.18.89.11.73.84z"/>
            </svg>
          </div>
